...
<div class="nav-scroller bg-white shadow-sm">
  <nav class="nav nav-underline">
    ...
    <a class="nav-link active" href="99991d972ad820b1d2f398e7a160eb03">Out Of Scope</a>
  </nav>
</div>
...
<main role="main" class="mr-2 ml-2">
  <div class="d-flex align-items-center p-3 my-3 rounded shadow-sm">
    ...
    <div class="lh-100">
      <h6 class="mb-0 lh-100" style="color:black">Out Of Scope</h6>
    </div>
  </div>
